...
cells.append({
    ...
    "source": [
        ...
        "# Colab Python 3.12: numpy 2.x + cupy pré-instalados quebram rembg→pymatting no launch.py\n",
        "!pip uninstall -y cupy cupy-cuda12x cupy-cuda11x cupy-cuda10x 2>/dev/null | true\n",
        "!pip install -q --force-reinstall numpy==1.26.4\n",
        "!pip install -q -r requirements_versions.txt\n",
        "!pip uninstall -y cupy cupy-cuda12x cupy-cuda11x cupy-cuda10x 2>/dev/null | true\n",
        "!pip install -q --force-reinstall rembg==2.0.57 pymatting==1.1.8\n",
