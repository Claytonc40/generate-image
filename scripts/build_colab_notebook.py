...
cells.append({
    ...
    "source": [
        ...
        "# Aguarde no output a linha \"Running on public URL\" ou um link *.gradio.live*\n",
        "import os\n",
        "os.chdir(\"/content/Fooocus\")\n",
        "args = \"--share --always-high-vram\"\n",
        "if FOOOCUS_PRESET:\n",
        "    args += f\" --preset {FOOOCUS_PRESET}\"\n",
        "cmd = f\"python entry_with_update.py {args}\"\n",
        "print(\"Executando:\", cmd)\n",
        "# subprocess com PIPE oculta o link do Gradio no Colab; shell herda stdout/stderr\n",
